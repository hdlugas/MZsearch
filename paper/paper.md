...
The user can use their own libraries, and by default, MZsearch provides
GC-MS and LC-MS reference libraries that have been trimmed. The
recommended GC-MS and LC-MS reference libraries are available at the
Zenodo database [@Dlugas2024_database]. The GC-MS library was extracted
from the National Institute of Standards and Technology WebBook, while
the LC-MS library was obtained from Global Natural Products Social
