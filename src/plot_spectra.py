...
parser.add_argument('--chromatography_platform', metavar='\b', help='Chromatography platform: options are \'LCMS\' and \'GCMS\'. Mandatory argument.')
...
parser.add_argument('--window_size_centroiding', metavar='\b', help='Window size parameter used in centroiding a given spectrum. Only for LCMS. Default = 0.5')
parser.add_argument('--window_size_matching', metavar='\b', help='Window size parameter used in matching a query spectrum and a reference library spectrum. Only for LCMS. Default = 0.5')
...
if chromatography_platform == 'LCMS':
...
# note the workflow is slightly different for LCMS and GCMS data
if chromatography_platform == 'LCMS':
